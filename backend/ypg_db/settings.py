...
# Use AWS S3 if credentials are provided, otherwise use local filesystem
...
if AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY and AWS_STORAGE_BUCKET_NAME:
    # Django 5 STORAGES config for S3
    STORAGES = {
        'default': {
    ...
    AWS_LOCATION = 'media'
    # Build MEDIA_URL from custom domain or S3 bucket endpoint
...
# Email Configuration via Resend SMTP for Database Application
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'District YPG Database <noreply@ahinsandistrictypg.com>')