    ...
    <div className="space-y-4 neumorphic-light dark:neumorphic-dark p-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-6 py-2 bg-blue-500 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-500 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 flex items-center hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
